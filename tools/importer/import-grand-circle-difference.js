...
// TRANSFORMER IMPORTS
import grandCircleDifferenceCleanupTransformer from './transformers/grand-circle-difference-cleanup.js';
...
const transformers = [
  grandCircleDifferenceCleanupTransformer,
];
...
export default {
  transform: (payload) => {
    ...
    // 6. Generate sanitized path. The source clone lives at /gcdifference/, but the
    // target document for this migration is /grand-circle-difference (the requested page name).
